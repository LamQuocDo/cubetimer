...
let savedType = localStorage.getItem("currentCubeType")
...
document.addEventListener("keyup", (e) => {
  if (e.code === "Space") {
    ...
    if (!running && canStart) {
      ...
      timerDisplay.style.color = document.body.classList.contains("light")
        ? "#000"
        : "#fff";
    } else if (running) {
      // Kết thúc solve
      ...
      document.getElementById("scramble").innerText = scramble.generate(); // Tạo scramble mới
    }
...
function updateAverages() {
  ao5Display.textContent = "avg5: " + calcAverage(5);
  ao12Display.textContent = "avg12: " + calcAverage(12);
}
